...
def parseArgs(argv):
    ...
    group_supervised.add_argument('--supervised', default=False, #action='store_true',
    ...
    group_save.add_argument('--pathCheckpoint', type=str, default='./exp_100_lstm_transformer_unsup/',
